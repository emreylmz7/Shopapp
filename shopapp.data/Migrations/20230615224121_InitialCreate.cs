    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "İyi telefon", "1.jpg", true, false, "Samsung S5", 5000.0, "samsung-s5" },
                    { 2, "güzel telefon", "2.jpg", true, false, "Samsung S6", 6000.0, "samsung-s6" },
                    { 3, "sağlam telefon", "3.jpg", false, false, "Samsung S7", 7000.0, "samsung-s7" },
                    { 4, "dayanıklı telefon", "4.jpg", true, false, "Samsung S8", 8000.0, "samsung-s8" },
                    { 5, "su geçirmez telefon", "5.jpg", false, false, "Samsung S10", 9000.0, "samsung-s10" }
                });
